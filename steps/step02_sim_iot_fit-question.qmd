...
Investment `I` is treated as exogenous final demand in the IO block and is not represented as a separate sectoral flow in this minimal TFM.
...
c_v_baseline_play <- 0.01  # TODO [optional:step2_cv] Change baseline c_v and inspect wealth and GDP without transition Hint: Keep baseline dynamics (no transition)
