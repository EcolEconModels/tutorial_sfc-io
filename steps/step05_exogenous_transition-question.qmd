...
plot(step5_baseline$year, step5_baseline$GDP, type = "l", lwd = 2, col = "steelblue",
     xlab = "year", ylab = "GDP", main = "Step 5 Core: GDP by closure")
...
plot(step5_baseline$year, step5_baseline$X_brown / pmax(step5_baseline$X_green, 1e-9),
     type = "l", lwd = 2, col = "steelblue",
     xlab = "year", ylab = "X_brown / X_green", main = "Step 5 Core: sector mix")
lines(step5_closure_play$year, step5_closure_play$X_brown / pmax(step5_closure_play$X_green, 1e-9),
      lwd = 2, col = "firebrick")
par(mfrow = c(1, 1))
```
